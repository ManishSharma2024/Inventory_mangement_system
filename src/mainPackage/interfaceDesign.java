...
public class interfaceDesign {
	...
	public void buildConnection() {
		...
		try {
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sampledb2", "root", "root");
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(727, 100, 1098, 765);
...
//		panel_2.setMinimumSize(new Dimension(16, 17));
